...
#define kInAppPurchaseProUpgradeProductId @"SoHoTip12"
...
{
    NSSet *productIdentifiers = [NSSet setWithObject:@"SoHoTip12" ];
...
- (void)productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
    ...
    proUpgradeProduct = [products count] == 1 ? products[0] : nil;
